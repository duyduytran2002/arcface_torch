...
from partial_fc_v2 import PartialFC_V2, PartialFC_Topology
...
def main(args):
    ...
    if cfg.optimizer == "sgd":
        module_partial_fc = PartialFC_Topology(
    ...
    ColorJitter = transforms.ColorJitter(brightness=[0.1, 0.5], hue=[-0.1, 0.3], contrast=[0.3, 0.6],
                                         saturation=[0.2, 0.5])
    ...
    for epoch in range(start_epoch, cfg.num_epoch):
        ...
        for _, (img, local_labels) in enumerate(train_loader):
            ...
            loss: torch.Tensor = module_partial_fc(img, local_embeddings, local_labels)
